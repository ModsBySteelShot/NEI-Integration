...
public class EntityDumper extends DataDumper {
    ...
    public Iterable<String[]> dump(int mode) {
        ...
        for (int id : ids) {
            list.add(
                    new String[] { GLOBAL, String.valueOf(id), EntityList.getStringFromID(id),
                            EntityList.getClassFromID(id).getName() });
        }

        ListMultimap<ModContainer, EntityRegistration> modEntities = ReflectionHelper
        ...
        for (Entry<ModContainer, EntityRegistration> e : modEntities.entries()) {
            ...
            list.add(
                    new String[] { e.getKey().getModId(), String.valueOf(er.getModEntityId()),
                            e.getKey().getModId() + "." + er.getEntityName(), er.getEntityClass().getName() });
        }
